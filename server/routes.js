...
export default (req, res) => {
    ...
    console.info(`${username} is authorized === `, isAuthorized)
    ...
    const PublishingAppRoutes = [
        ...
        {route: 'articles[{integers}]',
            get: (pathSet) => {
                ...
                return Article.find({}, '_id', (err, articlesDocs) => articlesDocs)
        ...
        {route: 'articles.add',
            call: (callPath, args) => {
                ...
                return article.save( (err, data) => {
                    ...
                    return Article.count({}, (err, count) => {})
                        .then( (count) => {
                            return { count, data }
                        })
                }).then( (res) => {
